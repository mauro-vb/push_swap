 ...
 * Low Disorder (< 0.2):
   * Strategy: Selection Sort / Simple.
 ...
 * mvazquez: Project structure, stack manipulation primitives (push, swap, rotate), argument parsing, main logic, simple sorting and turk sort implementation.
 * mpeskov: Benchmark system (t_bench), , complex sorting logic (Radix), and optimization of operation costs.
